...
import (
	...
	"github.com/sntruong12/josie-rides/internal/models/mocks"
...
func newTestApplication(t *testing.T) *application {
	...
	return &application{
		...
		rides:          &mocks.RideModel{}, // Use the mock.
...
func (ts *testServer) postForm(t *testing.T, urlPath string, form url.Values) (int, http.Header, string) {
	...
	// nosurf requires one of the three following headers in order to validate a request.
